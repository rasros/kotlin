...
public class JavaAgainstKotlinBinariesCheckerTestGenerated extends AbstractJavaAgainstKotlinBinariesCheckerTest {
    ...
    @TestMetadata("DeferredValReturnType.kt")
    public void testDeferredValReturnType() throws Exception {
        runTest("idea/testData/kotlinAndJavaChecker/javaAgainstKotlin/DeferredValReturnType.kt");
    }

    @TestMetadata("DeferredVarReturnType.kt")
    public void testDeferredVarReturnType() throws Exception {
        runTest("idea/testData/kotlinAndJavaChecker/javaAgainstKotlin/DeferredVarReturnType.kt");
    }
